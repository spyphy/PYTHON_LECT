...
Рассмотренные выше лямбда-выражения являются одним из основных элементов функционального программирования. Фунциональный подход используется при программировании на основе \emph{событий} (<<reactive>>), а также при параллельном программировании.
